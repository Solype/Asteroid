...
pub fn menu_plugin(app: &mut App) {
    ...
    app.add_systems(
        Startup,
        (
            setup_texture_camera,
            setup_cube_ptr,
            setup_sound_effect_and_music,
        ),
    );
    ...
    app.add_systems(
        ...
        (focus_main_screen, enter_menu_state, release_mouse),
    );
    ...
    app.add_systems(
        Update,
        (send_scroll_events, rebind_key, play_click_sound_system).run_if(in_state(GameState::Menu)),
    );
