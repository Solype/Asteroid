...
pub fn setup_metric_screen(
    ...
    commands.insert_resource(DistanceTimer(Timer::from_seconds(0.2, TimerMode::Repeating)));
...
pub fn apply_texture_to_quad(mut commands: Commands, screens: Query<(&MetricPlane, Entity)>, mut materials: ResMut<Assets<StandardMaterial>>, menu_texture: Res<MetricCameraTarget>)
{
...
pub fn setup_texture_camera(mut commands: Commands, mut images: ResMut<Assets<Image>>)
{
    ...
    commands.insert_resource(MetricCameraTarget { image: images.add(image) });
}
